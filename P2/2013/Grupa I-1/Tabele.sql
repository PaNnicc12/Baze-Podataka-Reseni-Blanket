...
(
    DOKUMENT NUMBER NOT NULL CONSTRAINT DOKUMENT_FK REFERENCES DOKUMENT(ID_DOKUMENTA),
    ZAPOSLENI NUMBER NOT NULL CONSTRAINT MBRPRAVOPRISTUPA_FK REFERENCES ZAPOSLENI(MBR),
    DATUM DATE NOT NULL,
    PRAVO CHAR NOT NULL CONSTRAINT PRAVO_CK CHECK(PRAVO IN('C', 'P')),
