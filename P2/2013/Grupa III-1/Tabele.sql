...
(
    ID NUMBER(10) NOT NULL CONSTRAINT BIBLIOTEKA_PK PRIMARY KEY,
...
CREATE TABLE KNJIGA
(
    ISBN NUMBER(10) NOT NULL CONSTRAINT KNJIGA_PK PRIMARY KEY,
...
(
    ID_BIBLIOTEKE NUMBER(10) NOT NULL CONSTRAINT BIBLIOTEKA_FK REFERENCES BIBLIOTEKA(ID),
    ISBN_KNJIGE NUMBER(10) NOT NULL CONSTRAINT KNJIGA_FK REFERENCES KNJIGA(ISBN),
    KOLICINA NUMBER(3) NOT NULL CONSTRAINT KOLICINA_CK CHECK(KOLICINA > 0),
    CONSTRAINT KNJIGAUBIBLIOTECI_PK PRIMARY KEY(ID_BIBLIOTEKE, ISBN_KNJIGE)
)
